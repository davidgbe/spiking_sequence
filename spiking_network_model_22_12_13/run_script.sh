...
caffeinate python run.py --env local --title rectified_STDP --rng_seed $3 --hetero_comp_mech none --stdp_type w_minus --dropout_per $1 --dropout_iter $2 --cond no_repl_no_syn --w_ee 0.4e-3 --w_ei 3.5e-5 --w_ie 4e-5 --silent_fraction 0 --alpha_5 6